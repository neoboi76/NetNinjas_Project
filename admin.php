...
<head>
    ...
    <meta name="Page" content="Admin Page">
...
<body id="signupForm">
    ...
    <section class="content">
        ...
        <div class="tab-content">
            ...
            <div id="employee" class="tab-pane fade">Employee Content</div>
            <div id="review" class="tab-pane fade">Review Content</div>
            <div id="department" class="tab-pane fade">Department Content</div>
